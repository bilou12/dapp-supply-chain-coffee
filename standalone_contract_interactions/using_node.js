...
const contract_address = '0xcec31315b8c453eae37d9d1b42a3842a69021812';
const contract_supply_chain = new web3.eth.Contract(contract_abi, contract_address);

console.log('contract_supply_chain: %j', contract_supply_chain)

// contract_supply_chain.methods.fetchItemBufferOne(1).call({
//     from: '0xc6696eDf5e753f5B3009608F9e25ED2cb713C7fA'
// }, (err, res) => {
//     console.log(res)
// })
