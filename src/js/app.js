App = {
    ...
    harvestItem: function (event) {
        ...
        console.log('Will harvest: upc: ' + App.upc);
        console.log('Will harvest: metamaskAccountID: ' + App.metamaskAccountID);
        console.log('Will harvest: originFarmName: ' + App.originFarmName);
        console.log('Will harvest: originFarmInformation: ' + App.originFarmInformation);
        console.log('Will harvest: originFarmLatitude: ' + App.originFarmLatitude);
        console.log('Will harvest: originFarmLongitude: ' + App.originFarmLongitude);
        console.log('Will harvest: productNotes: ' + App.productNotes);
